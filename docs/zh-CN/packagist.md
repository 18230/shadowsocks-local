...
- 仓库地址：`https://github.com/18230/php-shadowsocks-client`
- Composer 包名：`18230/php-shadowsocks-client`
- 重命名后首个建议提交到 Packagist 的版本标签：`v0.2.0`
...
提交成功后，Packagist 应该会自动识别仓库里已有的 `v0.2.0` 标签。
...
- 建议显式配置的 GitHub Repository Variable：`PACKAGIST_USERNAME`
  这个仓库应设置成 `aiqq363927173`，因为 Packagist 用户名和 GitHub owner 不一致。
